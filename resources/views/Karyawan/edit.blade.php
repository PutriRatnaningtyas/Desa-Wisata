...
@error('nama_karyawan') is-invalid @enderror" id="nama_karyawan" placeholder="Nama Karyawan" name="nama_karyawan"
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" name="alamat">{{$karyawan->alamat ??old('alamat')}}</textarea>
                        @error('alamat') <span class="textdanger">{{$message}}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="no_hp">Nomer Telepon</label>
                        <input type="number" class="form-control
@error('no_hp') is-invalid @enderror" id="no_hp" placeholder="Nomer Telepon" name="no_hp" value="{{$karyawan->no_hp ??old('no_hp')}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group"> -->
                            ...
                            <!-- <input type="text" class="form-control
@error('users') is-invalid @enderror" placeholder="users" id="users" name="users" value="{{$karyawan->users ??old('users')}}"
