...
@error('harga_per_pack') is-invalid @enderror" id="harga_per_pack" placeholder="harga_per_pack" name="harga_per_pack" value="{{old('harga_per_pack')}}">
                        @error('harga_per_pack') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="diskon">Diskon</label>
                        <input type="decimal" class="form-control 
@error('diskon') is-invalid @enderror" id="diskon" onkeyup="hitung()" placeholder="Diskon" name="diskon" value="{{old('diskon')}}">
