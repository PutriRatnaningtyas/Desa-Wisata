...
@error('judul') is-invalid @enderror" id="judul" placeholder="Judul" name="judul"
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" name="berita">{{old('berita')}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" 
                            ...
                            placeholder="Tanggal Post" name="tgl_post" value="{{old('tgl_post')}}">
...
id="kategori_berita" name="kategori_berita" value="{{old('kategori_berita')}}" aria-label="Kategori Berita" aria-describedby="cari" readonly>
