...
@error('nama_penginapan') is-invalid @enderror" id="nama_penginapan" placeholder="Nama Penginapan" name="nama_penginapan"
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" name="deskripsi">{{$penginapan->deskripsi ??old('deskripsi')}}</textarea>
