...
@stop
@section('content') 
    <form action="{{route('obwis.update', $obyek_wisata)}}" method="post" enctype="multipart/form-data">
        @method('PUT') 
        @csrf
    <div class="row">
        <div class="col-12">
...
@error('nama_wisata') is-invalid @enderror" id="nama_wisata" placeholder="nama_wisata" name="nama_wisata"
                            value="{{$obyek_wisata->nama_wisata ??old('nama_wisata')}}">
                        @error('nama_wisata') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="deskripsi_wisata">Deskripsi Wisata</label>
                        <textarea type="text" class="form-control" name="deskripsi_wisata">{{$obyek_wisata->deskripsi_wisata ??old('deskripsi_wisata')}}</textarea>
...
id="kategori_wisata" name="kategori_wisata" value="{{$obyek_wisata->kategori_wisata ??old('kategori_wisata')}}" aria-label="Kategori Wisata" aria-describedby="cari" readonly>
                        ...
                        <textarea type="text" class="form-control" name="fasilitas">{{$obyek_wisata->fasilitas ??old('fasilitas')}}</textarea>
